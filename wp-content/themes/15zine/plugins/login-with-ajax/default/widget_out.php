    ...
    <div class="lwa lwa-default clearfix">
        ...
        <form class="lwa-form cb-form cb-form-active clearfix" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
            ...
            <div class="cb-form-body">
                ...
                <div class="cb-remember-me cb-extra cb-ta-center"><label><?php esc_html_e( 'Remember Me','login-with-ajax' ) ?></label><input name="rememberme" type="checkbox" class="lwa-rememberme" value="forever" /></div>
