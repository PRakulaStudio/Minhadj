...
if ($cb_qry->have_posts()) : while ($cb_qry->have_posts()) : $cb_qry->the_post();
    ...
    <article
            id="post-<?php the_ID(); ?>" <?php post_class("cb-blog-style-b cb-bs-c cb-module-a cb-article cb-article-row-3 cb-article-row cb-img-above-meta clearfix cb-separated cb-no-$cb_count"); ?>>
