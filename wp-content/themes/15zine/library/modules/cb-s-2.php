...
if (($cb_section == 'c') || ($cb_section == 'a')) {
    ...
    $cb_slider_type = 'cb-slider-2 cb-slider-2-fw';
}
...
if ($cb_qry->have_posts()) {
    ...
    while ($cb_qry->have_posts()) : $cb_qry->the_post();
        ...
        if ($cb_count == 1) {
            echo '<div class="' . $cb_module_block_type . $cb_no_sidebar . ' clearfix"' . $cb_slider_ltr_rtl . '>' . $cb_title_header . '<div class="' . $cb_slider_type . ' cb-arrows-tr cb-relative clearfix"><ul class="slides clearfix">';
        }
        ?>
