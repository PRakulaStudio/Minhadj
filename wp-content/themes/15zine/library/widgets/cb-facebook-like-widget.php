...
if (!class_exists('CB_WP_Widget_facebook_box')) {
    ...
    class CB_WP_Widget_facebook_box extends WP_Widget
    {
        ...
        function __construct()
        {
            ...
            parent::__construct('facebook-box', '15Zine Facebook Box', $widget_ops);
        ...
        function form($instance)
        {
            ...
            <p><label for="<?php echo esc_attr($this->get_field_id('appid')); ?>">App ID: (You can get one from
                    https://developers.facebook.com/)</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('appid')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('appid')); ?>" type="text"
                       value="<?php echo esc_attr($appid); ?>"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('page')); ?>">Page name: (Without
                    http://www.facebook.com/)</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('page')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('page')); ?>" type="text"
                       value="<?php echo esc_attr($page); ?>"/></p>
