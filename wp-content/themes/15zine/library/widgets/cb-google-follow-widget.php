...
if (!class_exists('cb_google_follow_widget')) {
    class cb_google_follow_widget extends WP_Widget
    {
        ...
        function __construct()
        {
            ...
            parent::__construct('google-follow', '15Zine Google+ Follow Widget', $widget_ops);
        ...
        function widget($args, $instance)
        {
            ...
            if ($googleplus != NULL) {
                ...
                echo '<div class="clearfix"><div class="g-page" data-width="300" ' . $cb_style . ' data-layout="landscape"  data-href="' . $googleplus . '"  data-showtagline="false" data-showcoverphoto="false" data-rel="publisher"></div> 
        ...
        function form($instance)
        {
            ...
            <p><label for="<?php echo esc_attr($this->get_field_id('googleplus')); ?>">Google+ Page URL:</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('googleplus')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('googleplus')); ?>" type="text"
                       value="<?php echo esc_attr($googleplus); ?>"/></p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cb_color_style')); ?>"><?php echo "Style:"; ?></label>

                <select id="<?php echo esc_attr($this->get_field_id('cb_color_style')); ?>"
                        name="<?php echo esc_attr($this->get_field_name('cb_color_style')); ?>">
                    <option value="light" <?php if ($cb_color_style == 'light') echo 'selected="selected"'; ?>>Light
                    </option>
                    <option value="dark" <?php if ($cb_color_style == 'dark') echo 'selected="selected"'; ?>>Dark
                    </option>
