    ...
    class cb_single_image_widget extends WP_Widget
    {
        ...
        function form($instance)
        {
            ...
            <p><label for="<?php echo esc_attr($this->get_field_id('imgurl')); ?>">Image URL:</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('imgurl')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('imgurl')); ?>" type="text"
                       value="<?php echo esc_url($cb_image); ?>"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('retimgurl')); ?>">Retina Image URL:</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('retimgurl')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('retimgurl')); ?>" type="text"
                       value="<?php echo esc_url($cb_retina_image); ?>"/></p>
