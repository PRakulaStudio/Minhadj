...
if (!class_exists('cb_wp_125_ads_widget')) {
    class cb_wp_125_ads_widget extends WP_Widget
    {
        ...
        function __construct()
        {
            ...
            parent::__construct('ads-125', '15Zine 125px x 125px Ads', $widget_ops);
            $this->alt_option_name = 'cb_widget_small_squares';
        ...
        {
            $cache = wp_cache_get('cb_widget_small_squares', 'widget');
            ...
            if (is_home() || is_category() || is_tag() || is_singular() || is_archive()) { ?>
                ...
                <ul class="clearfix cb-small-squares-widget">
                    ...
                    <?php if ($ad_url_1 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_1) ?></li> <?php } ?>
                    <?php if ($ad_url_2 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_2) ?></li> <?php } ?>
                    <?php if ($ad_url_3 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_3) ?></li> <?php } ?>
                    <?php if ($ad_url_4 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_4) ?></li> <?php } ?>
                    <?php if ($ad_url_5 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_5) ?></li> <?php } ?>
                    <?php if ($ad_url_6 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_6) ?></li> <?php } ?>
                    <?php if ($ad_url_7 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_7) ?></li> <?php } ?>
                    <?php if ($ad_url_8 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_8) ?></li> <?php } ?>
                    <?php if ($ad_url_9 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_9) ?></li> <?php } ?>
                    <?php if ($ad_url_10 != NULL) { ?>
                        <li> <?php echo wpautop($ad_url_10) ?></li> <?php } ?>
            ...
            wp_cache_set('cb_widget_small_squares', $cache, 'widget');
        }
        ...
        function update($new_instance, $old_instance)
        {
            ...
            if (isset($alloptions['cb_widget_small_squares']))
                delete_option('cb_widget_small_squares');
        ...
        {
            wp_cache_delete('cb_widget_small_squares', 'widget');
        }
        ...
        function form($instance)
        {
            ...
            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_1')); ?>">Ad 1 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_1')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_1')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_1); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_2')); ?>">Ad 2 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_2')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_2')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_2); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_3')); ?>">Ad 3 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_3')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_3')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_3); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_4')); ?>">Ad 4 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_4')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_4')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_4); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_5')); ?>">Ad 5 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_5')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_5')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_5); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_6')); ?>">Ad 6 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_6')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_6')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_6); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_7')); ?>">Ad 7 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_7')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_7')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_7); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_8')); ?>">Ad 8 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_8')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_8')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_8); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_9')); ?>">Ad 9 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_9')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_9')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_9); ?>" size="3"/></p>

            <p><label for="<?php echo esc_attr($this->get_field_id('ad_url_10')); ?>">Ad 10 Code</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('ad_url_10')); ?>"
                       name="<?php echo esc_attr($this->get_field_name('ad_url_10')); ?>" type="text"
                       value="<?php echo esc_attr($ad_url_10); ?>" size="3"/></p>
