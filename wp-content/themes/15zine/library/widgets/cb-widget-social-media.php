        ...
        function form($instance)
        {
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>"
                       ...
                       value="<?php echo esc_attr($cb_title); ?>"/>
            </p>
            ...
            <p>
                ...
                <select id="<?php echo esc_attr($this->get_field_id('type')); ?>"
                    ...
                    <option value="cb-colors" <?php if ($cb_type == 'cb-colors') {
                        echo 'selected="selected"';
                    } ?>>Color Logos
                    </option>
                    <option value="cb-white" <?php if ($cb_type == 'cb-white') {
                        echo 'selected="selected"';
                    } ?>>White Logos
                    </option>
                </select>
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('twitter')); ?>"
                       ...
                       value="<?php echo esc_attr($cb_twitter); ?>"/>
            </p>
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('facebook')); ?>"
                       ...
                       value="<?php echo esc_attr($cb_facebook); ?>"/>
            </p>
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('youtube')); ?>"
                       ...
                       value="<?php echo esc_attr($cb_youtube); ?>"/>
            </p>
