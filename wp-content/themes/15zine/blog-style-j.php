...
if ($cb_qry->have_posts()) : while ($cb_qry->have_posts()) : $cb_qry->the_post();
    ...
    <article
            id="post-<?php the_ID(); ?>" <?php post_class("cb-blog-style-j cb-article-big cb-article-review cb-article cb-meta-style-2 cb-article-row cb-no-$cb_count clearfix cb-article-row-3"); ?>>
